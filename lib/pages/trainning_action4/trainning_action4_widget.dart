...
import 'trainning_action4_model.dart';
export 'trainning_action4_model.dart';

class TrainningAction4Widget extends StatefulWidget {
  const TrainningAction4Widget({super.key});

  @override
  State<TrainningAction4Widget> createState() => _TrainningAction4WidgetState();
}

class _TrainningAction4WidgetState extends State<TrainningAction4Widget>
    with TickerProviderStateMixin {
  late TrainningAction4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrainningAction4Model());
                                  ...
                                  child: Column(
                                    children: [
                                      Align(
                                        ...
                                        child: TabBar(
                                          labelColor: const Color(0xFF15181C),
                                          unselectedLabelColor:
                                              const Color(0xFF545F68),
                                          labelStyle:
